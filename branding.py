...
# Palette (for reference / future use)
PALETTE = {
    "petrol": "#0E3A46", "teal": "#1E7A8C", "aqua": "#57C4C9",
    "gold": "#E8B04B", "ink": "#12262B", "mist": "#F4F8F8",
}
...
def inject_style():
    ...
    st.markdown(
        ...
        .stApp { background-color: #F4F8F8; }
        h1, h2, h3, h4 { color: #0E3A46 !important; font-weight: 700; letter-spacing: 0.2px; }
        a { color: #155C6B; }

        /* teal buttons */
        .stButton > button {
            background-color: #1E7A8C; color: #FFFFFF; border: none;
            border-radius: 8px; font-weight: 600; padding: 0.45rem 1.1rem;
        }
        .stButton > button:hover { background-color: #155C6B; color: #FFFFFF; }
        ...
        .aria-hero {
            ...
            border-radius: 16px; padding: 18px 24px; margin: 0 0 14px 0;
...
def render_header(value_line="Your clinical thinking partner for rehabilitation decisions."):
    """The ARIA header band. Call once where the old title used to be."""
    st.markdown(
        f'''
        <div class="aria-hero">
